...
```{r GDP Growth, fig.width = 8, fig.height = 4, echo = FALSE}
plot(gdp_growth)
...
```{r GDP Composition, fig.width = 8, fig.height = 4, echo = FALSE}
plot(gdp_shares)
```
...
```{r Poverty, fig.width=7, fig.height=5, echo=FALSE}
plot(pov_plot)
```
...
```{r Inequality, fig.width=8, fig.height=6, , echo=FALSE}
plot(gini_plot)
```
...
```{r Infrastructure, fig.width=8, fig.height=6, fig.asp= 1, echo=FALSE}
plot(access_plot)
```
...
```{r Fertility, fig.width=8, fig.height=6, fig.asp= 1, echo=FALSE}
plot(fertility_plot)
```
...
```{r Mobile use, echo=FALSE, fig.asp=1, fig.height=6, fig.width=8}
plot(mobile_plot)
```
...
```{r ICT use, fig.width=8, fig.height=6, fig.asp= 1, echo=FALSE}
plot(ict_plot)
```
...
```{r Chronic Malnutrition, echo=FALSE, fig.width=8, fig.height = 6, fig.asp = 1, warning = FALSE}
plot(stunting_map)
```
```{r Chronic Malnutrition Line, echo=FALSE, fig.asp = 1, fig.height=6, fig.width=8}
plot(stunting_plot)
```
...
```{r Boundary Comparison, echo=FALSE, fig.width=8, fig.height = 6, fig.asp = 1}
plot(gha_compare)
```
